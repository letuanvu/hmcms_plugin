...
function hm_fbchat_fbroot()
{
    ...
    $auto_popup = get_option(['section' => 'hm_fbchat', 'key' => 'auto_popup', 'default_value' => 'yes']);
    $auto_popup_delay = get_option(['section' => 'hm_fbchat', 'key' => 'auto_popup_delay', 'default_value' => 'yes']);
...
function hm_fbchat_chatbox()
{
    ...
    $boxtitle = get_option(['section' => 'hm_fbchat', 'key' => 'boxtitle', 'default_value' => 'Hỗ trợ trực tuyến']);
    $fanpage = get_option(['section' => 'hm_fbchat', 'key' => 'fanpage', 'default_value' => '']);
