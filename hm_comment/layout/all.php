<link rel="stylesheet" type="text/css" href="<?php echo BASE_URL.HM_PLUGIN_DIR.'/hm_comment/asset'; ?>/datatables.min.css">
<link rel="stylesheet" type="text/css" href="<?php echo BASE_URL.HM_PLUGIN_DIR.'/hm_comment/asset'; ?>/custom.css">
<script type="text/javascript" src="<?php echo BASE_URL.HM_PLUGIN_DIR.'/hm_comment/asset'; ?>/datatables.min.js" charset="UTF-8"></script>
<div class="container">
  <div class="row">
              ...
              <table id="ordertable" class="table table-bordered">
                ...
                ?>
                  <tr class="<?php echo $bgclass; ?>">
                    ...
                    <td>
                      <a href="<?php echo $object_href; ?>" target="_blank"><?php echo $object_name; ?></a>
                    </td>
                    <td>
                      <?php
                    ...
                    <td>
                      ...
                      ?>
                      <span data-status="deleted" data-id="<?php echo $comment->id; ?>" class="btn btn-danger btn-xs ajax_update_cmt_status"><?php echo hme_lang('delete'); ?></span>
                    </td>
                  </tr>
                <?php
                }
