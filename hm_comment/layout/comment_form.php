...
<div class="hm_comment_wrapper" data-id="c_<?php echo $cid; ?>">
  <div class="hm_comment_input_wrapper hm_comment_name_wrapper">
    <input class="hm_comment_name hm_comment_input_name" placeholder="Mời bạn để lại tên..." data-id="c_<?php echo $cid; ?>">
  </div>
  <div class="hm_comment_input_wrapper hm_comment_content_wrapper">
    <textarea class="hm_comment_content hm_comment_input_content" placeholder="Mời bạn để lại bình luận..." data-id="c_<?php echo $cid; ?>"></textarea>
  </div>
