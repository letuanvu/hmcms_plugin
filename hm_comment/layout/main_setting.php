      ...
      <div class="row dashboard_box">
        <div class="list-form-input">
          ...
          $args = array(
            ...
            'input_type'=>'select',
            'input_option'=>array(
              array('value'=>'public','label'=>'Công khai'),
              array('value'=>'hidden','label'=>'Chờ kiểm duyệt'),
            ),
            'default_value'=>get_option( array('section'=>'hm_comment','key'=>'default_status','default_value'=>'hidden') ),
          );
          ...
          $args = array(
            ...
            'input_type'=>'text',
            'required'=>FALSE,
            'default_value'=>get_option( array('section'=>'hm_comment','key'=>'public_comment_submit_noti') ),
          );
          build_input_form($args);
          ...
          $args = array(
            ...
            'input_type'=>'text',
            'required'=>FALSE,
            'default_value'=>get_option( array('section'=>'hm_comment','key'=>'hidden_comment_submit_noti') ),
          );
          build_input_form($args);
          ...
          $args = array(
            ...
            'input_type'=>'text',
            'required'=>FALSE,
            'default_value'=>get_option( array('section'=>'hm_comment','key'=>'error_comment_submit_noti') ),
          );
          build_input_form($args);
