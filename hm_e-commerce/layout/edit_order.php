  ...
  <form action="" method="post">
    <div class="col-md-6">
      <div class="row admin_mainbar_box">
        ...
        <div class="form-group">
          ...
          <input name="email" type="text" class="form-control " disabled value="<?php echo $data['customer']->installment_partner; ?>">
        </div>
        <div class="form-group">
          <div class="form-group-handle"></div>
          <label for=""><?php echo hme_lang('installment_first_pay'); ?></label>
          <input name="email" type="text" class="form-control " disabled value="<?php echo $data['customer']->installment_first_pay; ?>">
        </div>
        <div class="form-group">
          <div class="form-group-handle"></div>
          <label for=""><?php echo hme_lang('installment_month'); ?></label>
          <input name="email" type="text" class="form-control " disabled value="<?php echo $data['customer']->installment_month; ?>">
        </div>
        <div class="form-group">
          <div class="form-group-handle"></div>
          <label for=""><?php echo hme_lang('installment_per_month_pay'); ?></label>
          <input name="email" type="text" class="form-control " disabled value="<?php echo $data['customer']->installment_per_month_pay; ?>">
        </div>
        <div class="form-group">
          <div class="form-group-handle"></div>
          <label for=""><?php echo hme_lang('installment_total_pay'); ?></label>
          <input name="email" type="text" class="form-control " disabled value="<?php echo $data['customer']->installment_total_pay; ?>">
        </div>
        <?php
        }
        ?>
    ...
    <div class="col-md-12">
      <div class="row admin_mainbar_box">
        ...
        <div class="form-group">
          <button name="save_order_setting" type="submit" class="btn btn-primary"><?php echo hme_lang('save'); ?></button>
          <a class="btn btn-primary" href="?run=admin_page.php&key=hm_ecommerce_edit_order&action=delete&id=<?php echo hm_get('id'); ?>"><?php echo hme_lang('delete_order'); ?></a>
        </div>
      </div>
    </div>
  </form>
