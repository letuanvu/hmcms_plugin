<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="row dashboard_box">
            <a href="<?php echo BASE_URL; ?>hm_ecommerce_explode_excel" target="_blank"
               class="btn btn-default media_btn">
    ...
    <div class="col-md-6">
        ...
        <div class="row dashboard_box">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    <input type="submit" name="submit_excel" class="btn btn-default"
                           value="<?php echo hme_lang('upload'); ?>">
                </div>
            </form>
        </div>
    </div>
    ...
    <form action="" method="post">
            ...
            <div class="row dashboard_box">
                <div class="list-form-input">
                    ...
                    $args = [
                        ...
                        'input_type' => 'text',
                        'required' => false,
                        'default_value' => get_option(['section' => 'hme', 'key' => 'noti_email', 'default_value' => '']),
                    ];
            ...
            <div class="row dashboard_box">
                <div class="list-form-input">
                    ...
                    $args = [
                        ...
                        'input_type' => 'select',
                        'input_option' => [
                            ['value' => 'yes', 'label' => hme_lang('yes')],
                            ['value' => 'no', 'label' => hme_lang('no')],
                        ],
                        'default_value' => get_option(['section' => 'hme', 'key' => 'product_photos', 'default_value' => 'yes']),
                    ];
                    build_input_form($args);
                    ...
                    $args = [
                        ...
                        'default_value' => get_option(['section' => 'hme', 'key' => 'product_options', 'default_value' => 'yes']),
                    ];
                    build_input_form($args);
                    ...
                    $args = [
                        ...
                        'default_value' => get_option(['section' => 'hme', 'key' => 'product_versions', 'default_value' => 'yes']),
                    ];
                    build_input_form($args);
                    ...
                    $args = [
                        ...
                        'default_value' => get_option(['section' => 'hme', 'key' => 'product_deal', 'default_value' => 'yes']),
                    ];
                    build_input_form($args);
                    ...
                    $args = [
                        ...
                        'input_type' => 'number',
                        'required' => false,
                        'default_value' => get_option(['section' => 'hme', 'key' => 'installment_interest_rate', 'default_value' => '10']),
                    ];
                    build_input_form($args);
                    ?>
                </div>
        ...
        <div class="col-md-12">
            <div class="form-group">
                <button name="save_hme_setting" type="submit"
                        class="btn btn-primary"><?php echo hm_lang('save'); ?></button>
            </div>
        </div>
