						...
						<div class="row">
							<div class="col-md-12 ">
								<div class="pull-right">
									<div class="btn-group">
										<a href="?run=admin_page.php&key=hm_ecommerce_product_option_add" class="btn btn-info btn-filter"><?php echo hme_lang('add_product_attributes'); ?></a>
									</div>
								</div>
							</div>
						</div>
							...
							<table id="ordertable" class="table table-bordered">
								...
								?>
									<tr>
										...
										<td>
											<a href="?run=admin_page.php&key=hm_ecommerce_product_option_edit&action=edit&id=<?php echo $group->id; ?>" class="btn btn-default btn-xs">Sửa</a>
											<a href="?run=admin_page.php&key=hm_ecommerce_product_option_delete&action=delete&id=<?php echo $group->id; ?>" class="btn btn-danger btn-xs">Xóa</a>
										</td>
									</tr>
								<?php
								}
