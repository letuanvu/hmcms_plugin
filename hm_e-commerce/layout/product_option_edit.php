                    ...
                    <div class="group_isset_option_panel">
                        <ul>
                            ...
                            foreach ($data['data_option'] as $option) {
                                ...
                                if (is_numeric($option->option_image) && $option->option_image != 0) {
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <button name="add_option" type="submit"
                                            class="form-control btn btn-info"><?php echo _('Thêm thuộc tính'); ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
