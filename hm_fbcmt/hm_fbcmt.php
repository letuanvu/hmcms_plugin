...
function fbcmt_enable(){
	...
	$args['default_value'] = get_con_val(array('name'=>'fbcmt_enable','id'=>hm_get('id')));
...
function fbcmt_number_cmt(){
	...
	$args['default_value'] = get_con_val(array('name'=>'fbcmt_number_cmt','id'=>hm_get('id')));
...
function hm_fbcmt_display_meta_appid(){
	$appid=get_option( array('section'=>'hm_fbcmt','key'=>'appid') );
	if($appid){
...
function fbcmt_display($value,$input){
	if(is_content()){
		...
		$location = get_option( array('section'=>'hm_fbcmt','key'=>'location_'.$content_key) );
		$fbcmt_number_cmt = get_option( array('section'=>'hm_fbcmt','key'=>'number_cmt') );
