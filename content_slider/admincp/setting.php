                ...
                <div class="list-form-input">
                    ...
                    foreach ($hmcontent->hmcontent as $content) {
                        ...
                        $args = [
                            ...
                            'default_value' => get_option(['section' => 'content_slider', 'key' => 'include_content_' . $content_key, 'default_value' => 'yes']),
                        ];
            ...
            <div class="row dashboard_box">
                <div class="form-group">
                    ...
                    $args = [
                        ...
                        'default_value' => get_option(['section' => 'content_slider', 'key' => 'jquery_plugin', 'default_value' => 'galleria']),
                    ];
                    build_input_form($args);
                    ?>
                </div>
                <div class="form-group jquery_plugin_setting jquery_plugin_galleria">
                    ...
                    $args = [
                        ...
                        'input_type' => 'number',
                        'required' => false,
                        'default_value' => get_option(['section' => 'content_slider', 'key' => 'galleria_height', 'default_value' => '600']),
                    ];
                    build_input_form($args);
                    ?>
                </div>
                <div class="form-group jquery_plugin_setting jquery_plugin_fancybox" style="display:none">
                    ...
                    $args = [
                        ...
                        'input_type' => 'textarea',
                        'required' => false,
                        'default_value' => get_option(['section' => 'content_slider', 'key' => 'fancybox_setting', 'default_value' => $default]),
                    ];
                    build_input_form($args);
                    ?>
                </div>
...
<script>
    $(document).ready(function () {
        var plugin = '<?php echo get_option(['section' => 'content_slider', 'key' => 'jquery_plugin', 'default_value' => 'galleria']); ?>';
