<div class="row" >
				...
				<div class="list-form-input">
					<?php
						$args = array(
							...
							'input_type'=>'select',
							'input_option'=>array(
													array('value'=>'taxonomy','label'=>'Theo từng danh mục'),
													array('value'=>'content','label'=>'Theo từng kiểu bài'),
													//array('value'=>'all','label'=>'Một bộ lọc chung cho toàn site'),
												),
							'default_value'=>get_option( array('section'=>'hm_filter','key'=>'filter_type','default_value'=>'taxonomy') ),
						);
						build_input_form($args);
					?>
					<div class="form-group">
						<button name="submit" type="submit" class="btn btn-primary"><?php echo _('Lưu cài đặt'); ?></button>
					</div>
				</div>
			</div>
		</div>
	...
	<?php
	$filter_type = get_option( array('section'=>'hm_filter','key'=>'filter_type','default_value'=>'taxonomy') );
			...
			<div class="row_margin">
				<div class="col-md-6">
					...
					<div class="filter_step_content filter_step_1_control">
						<input data-key="<?php echo $content_key; ?>" type="text" class="form-control filter_group_content_value_input" placeholder="Nhập tên nhóm lọc mới"><span data-key="<?php echo $content_key; ?>" class="btn btn-warning filter_group_content_value_submit">Thêm nhóm lọc</span>
					</div>
				</div>
				<div class="col-md-6">
					<div class="filter_step_title">
