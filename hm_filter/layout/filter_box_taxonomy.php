<div class="row_margin">
    <div class="col-md-6">
        ...
        <div class="filter_step_content filter_step_1_control">
            <input type="text" class="form-control filter_group_taxonomy_value_input"
                   placeholder="Nhập tên nhóm lọc mới"><span data-id="<?php echo hm_get('id', 0); ?>"
                                                             class="btn btn-warning filter_group_taxonomy_value_submit">Thêm nhóm lọc</span>
        </div>
    </div>
    <div class="col-md-6">
        <div class="filter_step_title">
