...
function express_form_all()
{
    ...
    $whereArray = ['key' => MySQL::SQLValue('express_form')];
...
register_request('express_form_submit', 'express_form_submit', ['name' => 'express_form_submit', 'menu' => false]);
function express_form_submit()
{
    if (isset($_POST['express_form_submit'])) {
        ...
        if ($form_noti_message_location == '') {
            $form_noti_message_location = 'bottom';
        }
        ...
        echo json_encode(['status' => $status, 'message' => $mes]);
...
function express_form_shortcode($args)
{
    ...
    switch ($type) {
        ...
        case 'date':
            ...
            $value = '';
            $format = 'dd/mm/yy';
            $class = 'class="express_form_datepicker" ';
            $id = '';
            $required = '';
            if (isset($args['name'])) {
                $name = 'name="' . $args['name'] . '" ';
