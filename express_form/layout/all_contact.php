...
<table class="table">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a data-input-type="contact_<?php echo $id; ?>" class="popup_input btn btn-info btn-xs ajax-view-contact">Xem</a>
				<a data-href="?run=admin_page.php&key=express_form_del_contact&id=<?php echo $id; ?>" class="btn btn-danger btn-xs ajax-remove-form-contact">Xóa</a>
			</td>
		</tr>
		<?php
		}
