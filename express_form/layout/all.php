...
<table class="table">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a href="?run=admin_page.php&key=express_form_edit&id=<?php echo $form_id; ?>" class="btn btn-default btn-xs">Sửa</a>
				<a data-href="?run=admin_page.php&key=express_form_del&id=<?php echo $form_id; ?>" class="btn btn-danger btn-xs ajax-remove-form">Xóa</a>
			</td>
		</tr>
		<?php
		}
