...
function star_ratings(){
	...
	$total_vote = get_option(array(
		'section' => 'star_ratings',
		'default_value' => 0,
		'key' => $option.'_total',
	));
	$number_vote = get_option(array(
		'section' => 'star_ratings',
		'default_value' => 0,
		'key' => $option.'_number',
	));
...
register_request('hm_star_ratings_ajax','hm_star_ratings_ajax',array('name'=>'Star Ratings Ajax','menu'=>FALSE));
