<link rel="stylesheet" type="text/css"
      href="<?php echo BASE_URL . HM_PLUGIN_DIR . '/bxslider/asset/admin'; ?>/style.css">
<script type="text/javascript" src="<?php echo BASE_URL . HM_PLUGIN_DIR . '/bxslider/asset/admin'; ?>/main.js"
...
<div class="row">
    <div class="col-md-9">
        <?php
        $slider = get_option(['section' => 'bxslider', 'key' => 'slides']);
                ...
                <tr data-id="<?php echo $key; ?>">
                    ...
                    <td>
                        <button type="button" data-image="<?php echo $image; ?>" data-id="<?php echo $key; ?>"
                                class="quick_save_slide btn btn-info ">Lưu
                        </button>
                        <button type="button" data-image="<?php echo $image; ?>" data-id="<?php echo $key; ?>"
                                class="quick_delete_slide btn btn-danger ">Xóa
                        </button>
                    </td>
                </tr>
                <?php
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <button name="add_slider" type="submit"
        ...
        <form action="" method="post">
            ...
            <div class="bxsider_config_bar">
                ...
                foreach ($setting as $op_key => $op_val) {
                    $default_value = get_option(['section' => 'bxslider', 'key' => $op_key]);
                    if ($default_value == '') {
                    ...
                    $args = [
                        ...
                        'input_type' => 'text',
                        'required' => false,
                        'default_value' => get_option(['section' => 'bxslider', 'key' => $op_key, 'default_value' => $default_value]),
                    ];
                    build_input_form($args);
                }
                $args = [
                    ...
                    'input_type' => 'textarea',
                    'required' => false,
                    'default_value' => get_option(['section' => 'bxslider', 'key' => 'custom_script', 'default_value' => '']),
                ];
                build_input_form($args);
                ?>
            </div>
            <div class="form-group">
                <div class="form-group-handle"></div>
                <label for="field_append">Hành động</label>
                <button name="bxslider_save_config" type="submit"
