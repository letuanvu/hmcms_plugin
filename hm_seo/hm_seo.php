...
function seo_content_box()
{
    ...
    <div role="tabpanel">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#meta" aria-controls="meta" role="tab"
                                                      data-toggle="tab"><?php
                    echo _('Các thẻ meta');
                    ?></a></li>
            <li role="presentation"><a href="#sitemap" aria-controls="sitemap" role="tab" data-toggle="tab"><?php
                    echo _('Sitemap');
                    ?></a></li>
            <li role="presentation"><a href="#open_graph_tags" aria-controls="open_graph_tags" role="tab"
                                       data-toggle="tab"><?php
                    echo _('Open Graph tags');
                    ?></a></li>
            <li role="presentation"><a href="#custom_script" aria-controls="custom_script" role="tab"
                                       data-toggle="tab"><?php
...
function seo_box_meta()
{
    ...
    if (hm_get('run') == 'taxonomy.php') {
        $args['default_value'] = get_tax_val([
            'name' => 'title',
            'id' => hm_get('id')
        ]);
    } else if (hm_get('run') == 'content.php') {
        $args['default_value'] = get_con_val([
            'name' => 'title',
            'id' => hm_get('id')
        ]);
    }
...
function hm_seo_display_title($title)
{
    ...
    $request_data = get_uri_data([
        'uri' => $request
    ]);
    if ($request == '') {
        $home_title = get_option([
            'section' => 'hm_seo',
            'key' => 'home_title'
        ]);
        if ($home_title != '') {
