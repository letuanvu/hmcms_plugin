...
?>
	<div role="tabpanel">
	  ...
	  <ul class="nav nav-tabs" role="tablist">
		<li role="presentation" class="active"><a href="#meta" aria-controls="meta" role="tab" data-toggle="tab"><?php
    echo _('Các thẻ meta');
?></a></li>
		<li role="presentation"><a href="#sitemap" aria-controls="sitemap" role="tab" data-toggle="tab"><?php
    echo _('Sitemap');
?></a></li>
		<li role="presentation"><a href="#open_graph_tags" aria-controls="open_graph_tags" role="tab" data-toggle="tab"><?php
    echo _('Open Graph tags');
?></a></li>
		<li role="presentation"><a href="#custom_script" aria-controls="custom_script" role="tab" data-toggle="tab"><?php
    echo _('Mã nhúng tùy chỉnh');
?></a></li>
	  </ul>
	  <!-- Tab panes -->
...
function seo_box_meta() {
    ...
    if (hm_get('run') == 'taxonomy.php') {
        $args['default_value'] = get_tax_val(array(
            'name' => 'title',
            'id' => hm_get('id')
        ));
    } elseif (hm_get('run') == 'content.php') {
        $args['default_value'] = get_con_val(array(
            'name' => 'title',
            'id' => hm_get('id')
        ));
    }
...
function hm_seo_display_title($title) {
    ...
    $request_data = get_uri_data(array(
        'uri' => $request
    ));
    if ($request == '') {
        $home_title = get_option(array(
            'section' => 'hm_seo',
            'key' => 'home_title'
        ));
        if ($home_title != '') {
...
function hm_seo_display_ogdescription() {
    ...
    $request = get_current_uri();
    if ($request == '') {
        $ogdescription = get_option(array(
            'section' => 'hm_seo',
            'key' => 'ogdescription',
            'default_value' => ''
        ));
...
function hm_seo_display_custom_script_head() {
    ...
    $request = get_current_uri();
    if ($request == '') {
        $custom_script = get_option(array(
            'section' => 'hm_seo',
            'key' => 'custom_script_head',
            'default_value' => ''
        ));
...
register_request('sitemap.xml', 'hm_seo_sitemap', array(
    'name' => 'Sitemap XML',
    'menu' => TRUE
));
...
register_request('robots.txt', 'hm_seo_robotstxt', array(
    'name' => 'Robots.txt',
    'menu' => TRUE
));
