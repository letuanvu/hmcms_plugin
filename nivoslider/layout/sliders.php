...
<div class="row">
	<form action="" method="post">
		...
		<div class="col-md-3">
			<button type="submit" name="add_slider" class="form-control btn btn-info"><?php echo _('Thêm slider mới'); ?></button>
		</div>
	</form>
</div>
<div class="row">
	<table class="table">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="?run=admin_page.php&key=nivoslider_slide_setting&id=<?php echo $row->id; ?>" class="btn btn-default btn-xs">Sửa</a>
					<a data-href="?run=admin_page.php&key=nivoslider_slide_delete&id=<?php echo $row->id; ?>" class="btn btn-danger btn-xs ajax-remove-form">Xóa</a>
				</td>
			</tr>
			<?php
			}
