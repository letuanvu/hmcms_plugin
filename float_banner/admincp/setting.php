        ...
        <div class="col-md-4">
            <div class="row dashboard_box">
                ...
                $args = [
                    ...
                    'input_type' => 'number',
                    'required' => true,
                    'default_value' => get_option(['section' => 'float_banner', 'key' => 'site_wrapper_width', 'default_value' => '1170']),
                ];
        ...
        <div class="col-md-4">
            <div class="row dashboard_box">
                ...
                $args = [
                    ...
                    'input_type' => 'number',
                    'required' => true,
                    'default_value' => get_option(['section' => 'float_banner', 'key' => 'banner_left_width', 'default_value' => '100']),
                ];
                build_input_form($args);
                ?>
            </div>
        ...
        <div class="col-md-4">
            <div class="row dashboard_box">
                ...
                $args = [
                    ...
                    'input_type' => 'number',
                    'required' => true,
                    'default_value' => get_option(['section' => 'float_banner', 'key' => 'banner_right_width', 'default_value' => '100']),
                ];
                build_input_form($args);
                ?>
            </div>
        ...
        <div class="col-md-4">
            <div class="row dashboard_box">
                ...
                $args = [
                    ...
                    'input_type' => 'number',
                    'required' => true,
                    'default_value' => get_option(['section' => 'float_banner', 'key' => 'banner_margin_top', 'default_value' => '0']),
                ];
                build_input_form($args);
                ?>
            </div>
        ...
        <div class="col-md-4">
            <div class="row dashboard_box">
                ...
                $args = [
                    ...
                    'input_type' => 'number',
                    'required' => true,
                    'default_value' => get_option(['section' => 'float_banner', 'key' => 'banner_margin_bottom', 'default_value' => '0']),
                ];
                build_input_form($args);
                ?>
            </div>
        ...
        <div class="col-md-6">
            <div class="row dashboard_box">
                ...
                $args = [
                    ...
                    'input_type' => 'editor',
                    'required' => false,
                    'default_value' => get_option(['section' => 'float_banner', 'key' => 'banner_left']),
                ];
                build_input_form($args);
                ?>
            </div>
        ...
        <div class="col-md-6">
            <div class="row dashboard_box">
                ...
                $args = [
                    ...
                    'input_type' => 'editor',
                    'required' => false,
                    'default_value' => get_option(['section' => 'float_banner', 'key' => 'banner_right']),
                ];
                build_input_form($args);
                ?>
            </div>
