...
function float_banner_display()
{
    ...
    $site_wrapper_width = get_option(['section' => 'float_banner', 'key' => 'site_wrapper_width', 'default_value' => '1170']);
    $banner_left_width = get_option(['section' => 'float_banner', 'key' => 'banner_left_width', 'default_value' => '100']);
    $banner_right_width = get_option(['section' => 'float_banner', 'key' => 'banner_right_width', 'default_value' => '100']);
    $banner_margin_top = get_option(['section' => 'float_banner', 'key' => 'banner_margin_top', 'default_value' => '0']);
    $banner_margin_bottom = get_option(['section' => 'float_banner', 'key' => 'banner_margin_bottom', 'default_value' => '0']);
    $banner_left = get_option(['section' => 'float_banner', 'key' => 'banner_left']);
    $banner_right = get_option(['section' => 'float_banner', 'key' => 'banner_right']);
